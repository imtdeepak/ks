...
public class SelectionSort {
   ...
   * position, then find the second smallest element and exchange it with the element in the second
   * position, and continues in this way until the entire array is sorted.
   *
   * <p>Selection sort is one of the O(n2) sorting algorithms, which makes it quite inefficient for
   * sorting large data volumes
   *
   * <p>Worst Case Time Complexity: O(n2) Best Case Time Complexity : O(n2) Average Time Complexity
